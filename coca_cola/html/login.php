...
<body>
<form method="post" action="../php/logare_cont.php" name="form_login" onsubmit="return validare()">
    <table class="tabel" align="center" style="margin-bottom: 100px;">
        <tr><th><h1 class="titlu" align="center">Login</h1></th></tr>
        <tr><td>Email</td></tr>
        <tr><td><input type="text" name="email" size="30" placeholder="email@example.com"></td></tr>
        <tr><td>Password</td></tr>
        <tr><td><input type="password" name="parola" size="30"></td></tr>
        <tr><td><input type="submit"  value="Log in"></td></tr>
        <tr><td>You dont't have account?<br><a id="register" href="../html/register.php"><b>Register</b></a></td></tr>
    </table>
</form>
<div class="jos">
...
<ul id="bara">
    ...
    <li><a href="despre_noi.php">About us</a></li>
